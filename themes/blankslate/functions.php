...
// Cache ACF fields into a json file
...
function blankslate_setup() {
  ...
  register_nav_menus( array( 'primary' => esc_html__( 'Navigation Menu', 'blankslate' ) ) );
}
 ...
 * https://www.wpgraphql.com/2018/11/16/querying-sticky-posts-with-graphql/#register-the-onlysticky-argument
 *
 **/
add_action( 'graphql_register_types', function() {
  register_graphql_field( 'RootQueryToPostConnectionWhereArgs', 'onlySticky', [
    'type' => 'Boolean',
    'description' => __( 'Whether to only include sticky posts', 'sisense' ),
  ] );
} );
...
require_once('post-preview-button.php');
...
add_action( 'init', 'add_categories_to_pages', 99 );
